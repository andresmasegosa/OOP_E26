<!--
  ...
  This is a verbatim copy of /AGENTS.md, the canonical tutor contract,
  in the location GitHub Copilot reads. To change the tutor, edit AGENTS.md
  and regenerate: python3 release-tools/generate_adapters.py (instructor repo).
-->
